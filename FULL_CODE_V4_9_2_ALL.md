...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=4.9.3">
</head>
<body>
...
<script type="module" src="./app.js?v=4.9.3"></script>
  ...
  <main class="wrap admin-wrap">
    ...
    <section id="adminDashboard" class="hidden">
      <div class="admin-titlebar">
        ...
        <div>
          <a class="btn gm-zone-entry" href="./zone.html?v=4.9.3">🌙 เข้า 2D Zone · GM</a>
      ...
      <section id="zoneChatLogTab" class="admin-tab-panel hidden">
        ...
        <div class="admin-world-chat-composer">
          ...
          <div class="admin-world-chat-input-row">
            ...
            <a class="btn gm-zone-entry" href="./zone.html?v=4.9.3#world-chat">เข้า World Chat</a>
          </div>
        </div>
...
<body class="zone47-page">
  ...
  <script type="module" src="./zone.js?v=4.9.3"></script>
</body>
</html>
...
/* ===== V4.9.3 DEPARTMENT + MAJOR RANKING ===== */
