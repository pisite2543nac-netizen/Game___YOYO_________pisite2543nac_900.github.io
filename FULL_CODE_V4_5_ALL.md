...
5. Firebase → Firestore Database → Rules → ลบ Rules เดิม → วาง `firestore.rules` V4.5 ทั้งไฟล์ → Publish
...
ดู `UPDATE_V4_4_RANKING_PVP_ECONOMY.md` และ `DEPLOY_STEP_BY_STEP.md`
...
<body class="admin-page">
  <main class="wrap admin-wrap">
    ...
    <section id="adminDashboard" class="hidden">
      <div class="admin-titlebar">
        ...
        <div>
          <a class="btn gm-zone-entry" href="./zone.html?v=4.5.0">🌙 เข้า 2D Zone · GM</a>
      ...
      <section id="classroomsTab" class="admin-tab-panel hidden">
        <div class="panel-title">
          <div>
            <h2>ข้อมูลนักศึกษาแยกตามห้อง</h2>
            <p>เลือกห้อง เช่น ปวช.2/1 เพื่อดูโล่ Rank จำนวนด่าน Score ธรรมดา Score ทางการ และอันดับ Rank ทั้งในห้อง/รวม</p>
          </div>
          <div class="admin-class-filter-wrap">
            <label><span>ห้องที่กำลังดู</span><select id="adminClassroomFilter"></select></label>
          </div>
        </div>
        <div id="adminClassroomCards" class="admin-classroom-cards"></div>
        <div class="admin-classroom-summary">
          <strong id="adminClassroomTitle">-</strong>
          <span id="adminClassroomSummary">-</span>
        </div>
        <div class="table-wrap">
          <table class="admin-classroom-table">
            <thead><tr>
              <th>รหัสนักศึกษา</th><th>ชื่อ</th><th>โล่ Rank</th><th>ด่านที่เล่น</th>
      ...
      <section id="rankingTab" class="admin-tab-panel hidden">
        ...
        <div class="ranking-season-banner">
          ...
          <label class="admin-ranking-filter"><span>แสดง</span><select id="adminRankingClassFilter"><option value="">ทุกห้อง</option></select></label>
        </div>
        <div class="table-wrap">
          <table>
            <thead>
      ...
      <section id="zoneChatLogTab" class="admin-tab-panel hidden">
        ...
        <div class="admin-world-chat-composer">
          ...
          <div class="admin-world-chat-input-row">
            ...
            <a class="btn gm-zone-entry" href="./zone.html?v=4.5.0#world-chat">เข้า World Chat</a>
          </div>
        </div>
  ...
  <script type="module" src="./admin.js?v=4.5.0"></script>
</body>
</html>
...
import { LANGUAGES, LESSONS, DIFFICULTIES } from "./lessons.js?v=4.5.0";
import { REWARD_ITEMS, RARITY_META } from "./reward-data.js?v=4.5.0";
import { DEFAULT_CHARACTER, DEFAULT_ZONE_STATE } from "./character-system.js?v=4.5.0";
import { OFFICIAL_STAGES, OFFICIAL_TOTAL_SCORE } from "./official-data.js?v=4.5.0";
import { RANKING_CONFIG, seasonIdFromDate, seasonRange, calculateRankMetrics, rankingClassKey, rankProfiles } from "./ranking-system.js?v=4.5.0";
import { TOKEN_REWARD_CONFIG, calculateStageTokenReward, maxTokenForLesson, classKey } from "./economy-system.js?v=4.5.0";
...
async function routeAuthenticatedStudent(){
  ...
  if(isMobileOrTabletDevice() && ["male","female"].includes(state.player?.character?.gender)){
    ...
    location.replace("./zone.html?v=4.5.0");
    return;
  }
...
/* ===== V4.5 PVP MULTI ROOM · 1/3/5 SHOT · 1V1/2V2 RELAY · TOKEN WAGER ===== */
...
onAuthStateChanged(auth,async user=>{
  ...
  if(user.email==="pisit_2000@thc-nr.local"){location.replace("./admin.html?v=4.5.0");return;}
  state.uid=user.uid;
  try{
    await routeAuthenticatedStudent();
  }catch(error){
...
```html
<!DOCTYPE html><html lang="th"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="refresh" content="0;url=./zone.html?v=4.5.0"><title>ย้ายไป 2D Zone</title><script>location.replace("./zone.html?v=4.5.0");</script></head><body><p>ระบบแชตรวมย้ายเข้า 2D Zone แล้ว</p><a href="./zone.html?v=4.5.0">เข้า 2D Zone</a></body></html>
```
...
```javascript
import { HTML_LEVELS } from "./levels-html.js?v=4.5.0";
import { PYTHON_LEVELS } from "./levels-python.js?v=4.5.0";
...
/* =====================================================================
   V4.5 — DUAL RANKING / PVP MULTI ROOM / TOKEN ECONOMY / ITEM SET 2
   ===================================================================== */
...
/* ==================================================================
   V4.5 ADMIN CLASSROOM / RANK RESET / GM WORLD CHAT / PVP COUNTDOWN
   ================================================================== */
...
<body class="zone-v41-page">
  <div id="zoneGate" class="zone-v40-gate">
    <div class="zone-v40-gate-card">
      ...
      <span class="section-kicker">2D ZONE · V4.5.0</span>
  ...
  <main id="zoneApp" class="zone-v40-app hidden">
    ...
    <section id="zoneWorld" class="zone-v40-world" data-period="night">
      ...
      <div id="zoneRankResetNotice" class="zone-rank-reset-notice hidden">
        <span>🏆 RANK RESET</span>
        <strong id="zoneRankResetText">-</strong>
      </div>
  ...
  (function(){
    ...
    function fail(message){
      ...
      if(h()){
        ...
        h().innerHTML="<strong>ตรวจไฟล์ V4.5.0</strong><p>อัปโหลดไฟล์ทั้งชุดและ Publish firestore.rules เวอร์ชันเดียวกัน</p>";
      }
    }
  ...
  <script type="module" src="./zone.js?v=4.5.0"></script>
</body>
</html>
```
