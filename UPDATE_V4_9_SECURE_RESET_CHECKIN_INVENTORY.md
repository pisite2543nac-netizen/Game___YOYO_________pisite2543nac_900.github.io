# V4.9.2 — Secure Password Reset + Daily Fullscreen Check-in + Inventory 25
...
V4.9.2 จึงเพิ่ม **ตั้งรหัสผ่านใหม่** ผ่าน Cloud Function `adminResetStudentPassword` ซึ่งตรวจ ADMIN_UID ก่อนเรียก Firebase Admin SDK
