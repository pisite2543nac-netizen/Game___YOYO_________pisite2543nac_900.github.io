# FULL CODE V4.9.6 — COMPLETE CURRENT SOURCE
...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=4.9.6">
</head>
<body>
...
<script type="module" src="./app.js?v=4.9.6"></script>
...
<body class="admin-page">
  <main class="wrap admin-wrap">
    ...
    <section id="adminDashboard" class="hidden">
      <div class="admin-titlebar">
        ...
        <div>
          <a class="btn gm-zone-entry" href="./zone.html?v=4.9.6">🌙 เข้า 2D Zone · GM</a>
      ...
      <section id="zoneChatLogTab" class="admin-tab-panel hidden">
        ...
        <div class="admin-world-chat-composer">
          ...
          <div class="admin-world-chat-input-row">
            ...
            <a class="btn gm-zone-entry" href="./zone.html?v=4.9.6#world-chat">เข้า World Chat</a>
          </div>
        </div>
  ...
  <script type="module" src="./admin.js?v=4.9.6"></script>
</body>
</html>
...
<body class="zone47-page">
  ...
  <script type="module" src="./zone.js?v=4.9.6"></script>
</body>
</html>
...
```html
<!DOCTYPE html><html lang="th"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="refresh" content="0;url=./zone.html?v=4.9.6"><title>ย้ายไป 2D Zone</title><script>location.replace("./zone.html?v=4.9.6");</script></head><body><p>ระบบแชตรวมย้ายเข้า 2D Zone แล้ว</p><a href="./zone.html?v=4.9.6">เข้า 2D Zone</a></body></html>
```
...
/* ===== V4.9.6 DEPARTMENT + MAJOR RANKING ===== */
...
/* ===== V4.9.6 TYPING PERFORMANCE RANK ===== */
...
import { getFunctions, httpsCallable } from "https://www.gstatic.com/firebasejs/12.2.1/firebase-functions.js";
import { firebaseConfig, ADMIN_UID } from "./firebase-config.js?v=4.9.6";
import { REWARD_ITEMS, RARITY_META, INVENTORY_CAPACITY, SHOP_BUYBACK_RATE } from "./reward-data.js?v=4.9.6";
import { DEFAULT_CHARACTER } from "./character-system.js?v=4.9.6";
import {
...
function startQuest(id){
  ...
  location.href=`./index.html?quest=${encodeURIComponent(id)}&v=4.9.6`;
}
...
```js
import { HTML_LEVELS } from "./levels-html.js?v=4.9.6";
import { PYTHON_LEVELS } from "./levels-python.js?v=4.9.6";
